...
FARE_COST = 3
TEST_STATION = "beacon_staton_test"
TEST_VEHICLE = "beacon_bus_test"
...
while True:
    ...
    for dev in devices:
        for (adtype, desc, value) in dev.getScanData():
            if dev.rssi > -60:
                if ******___keytag not in keyTagSet:
                    # if hasnt been seen before, that means a new trip
                    tripData = {"tagID": ******___keytag,  "station": TEST_STATION,
